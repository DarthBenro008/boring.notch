...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "customnotch.customnotch.CustomNotchXPCHelper"
    
    private var remoteService: RemoteXPCService<CustomNotchXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<CustomNotchXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<CustomNotchXPCHelperProtocol>(
            connection: conn,
            remoteInterface: CustomNotchXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<CustomNotchXPCHelperProtocol>? {
        remoteService
    }
